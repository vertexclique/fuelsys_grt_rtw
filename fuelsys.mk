###########################################################################
## Makefile generated for Simulink model 'fuelsys'.
##
## Makefile     : fuelsys.mk
## Generated on : Thu Nov 15 01:40:20 2018
## MATLAB Coder version: 4.1 (R2018b)
##
## Build Info:
##
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/fuelsys
...
MASTER_ANCHOR_DIR         =
START_DIR                 = /Users/vertexclique/Documents/MATLAB/rts_embedded
ARCH                      = maci64
SOLVER                    =
SOLVER_OBJ                =
CLASSIC_INTERFACE         = 0
...
# C_STANDARD_OPTS           = -fno-common -fexceptions -emit-llvm
...
# LDFLAGS              = -arch $(ARCHS) -L"$(MATLAB_ARCH_BIN)" -flto -fuse-ld=gold -Wl,-plugin-opt=emit-llvm
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/fuelsys
...
DEFINES_STANDARD = -DMODEL=fuelsys -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/fuelsys_grt_rtw/fuelsys.c $(START_DIR)/fuelsys_grt_rtw/fuelsys_data.c $(START_DIR)/fuelsys_grt_rtw/rtGetInf.c $(START_DIR)/fuelsys_grt_rtw/rtGetNaN.c $(START_DIR)/fuelsys_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.o fuelsys.o fuelsys_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o
...
%.o : $(START_DIR)/fuelsys_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/fuelsys_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
